...
📚 **Теория:** в папке [`lessons/`](lessons/) — мини-учебник из 7 уроков о том,
как надо (и как не надо) анализировать результаты прогонов вместе с ИИ: триаж,
таксономия, пакет контекста, промпт, конвейер, метрики и перенос на свой проект.
